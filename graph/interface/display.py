"""Human-readable string representation of a Graph."""
...
def graph_string(g: Graph) -> str:
    """Return a compact human-readable summary of a Graph."""
    lines: List[str] = []
    lines.append("Graph:")
    ...
    for line in _format_node(Node(kind="Block", children=g.nodes), indent=1):
        lines.append(line)
    return "\n".join(lines)
